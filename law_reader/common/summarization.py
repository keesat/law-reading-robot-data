...
class Summarization(Summarizer):
   ...
   os.environ["OPENAI_API_KEY"] = "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"

   def __init__(self,llm=None):
      api_key = os.environ["OPENAI_API_KEY"]  # os.environ.get('OPENAI_API_KEY')
...
#summary = summarizer.get_summary(full_text)
#print(summary)
